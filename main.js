...
function createChart(chartSelector, data) {
    ...
    var container = document.querySelector(chartSelector);
    ...
    for (var user of data) {
        ...
        row.innerHTML = `<td> ${user.id}</td> <td> ${user.first_name}</td><td> ${user.last_name}</td> <td> ${user.email}</td>`
